...
public enum ArrowRequirements {
	BRONZE_ARROW(882, 1), IRON_ARROW(884, 1), STEEL_ARROW(886, 5), MITHRIL_ARROW(888, 20), ADAMANT_ARROW(890, 30), RUNE_ARROW(892, 40), DRAGON_ARROW(11212, 61), BOLT_RACK(4740, 70);
	...
	public static boolean canUseArrowWithBow(Player player) {
		Item bow = player.getEquipment().get(Equipment.WEAPON_SLOT);
		Item arrow = player.getEquipment().get(Equipment.ARROWS_SLOT);
