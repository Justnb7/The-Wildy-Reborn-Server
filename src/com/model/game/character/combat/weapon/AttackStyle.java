...
public class AttackStyle {
	...
	public enum FightType {
		...
		DART_ACCURATE(43, 0, 17102, RANGE_ACCURATE),
		DART_RAPID(43, 1, 17101, RANGE_RAPID),
		DART_LONGRANGE(43, 2, 17100, RANGE_LONGRANGE),
		BOW_ACCURATE(43, 0, 6236, RANGE_ACCURATE),
		BOW_RAPID(43, 1, 6235, RANGE_RAPID),
		BOW_LONGRANGE(43, 2, 6234, RANGE_LONGRANGE),
