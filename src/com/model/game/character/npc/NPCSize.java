...
public class NPCSize {
	...
	public static void init() throws IOException {
		final BufferedReader reader = new BufferedReader(new FileReader("./Data/text_files/npc_sizes.txt"));
		String line = null;
		...
		reader.close();
		//logger.info("Successfully loaded " + (NPC_SIZES.length - 1) + " npc sizes in " + (System.currentTimeMillis() - startup) + "ms");
	}
	...
	private static final int[] NPC_SIZES = new int[7000];
}
