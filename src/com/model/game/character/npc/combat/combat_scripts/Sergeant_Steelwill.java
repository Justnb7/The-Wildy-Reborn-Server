...
public class Sergeant_Steelwill extends Boss {
	...
	public void execute(Npc npc, Player player) {
		npc.playGraphics(Graphic.create(1216, 0, 0));
		...
		player.getProjectile().createPlayersProjectile(npc.getX(), npc.getY(), offX, offY, 50, speed, 1217, 43, 31, -player.getId() - 1, 65, 0, 36);
	}
