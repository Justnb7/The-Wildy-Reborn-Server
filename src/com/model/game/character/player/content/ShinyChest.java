...
public class ShinyChest {
	...
	public static final Item[] COMMON_CHEST_REWARDS = { new Item(4151), new Item(6585), new Item(4153), new Item(6731), new Item(6733), new Item(6735), new Item(6737), new Item(11283), new Item(12596), new Item(2581), new Item(2578) };
