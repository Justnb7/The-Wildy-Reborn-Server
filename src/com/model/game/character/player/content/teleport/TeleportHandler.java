...
public class TeleportHandler {
	...
	public enum TeleportData {
		...
		KRAKEN(TeleportationTypes.PVM, 222227, 57062, "Kraken", new Location(3696, 5707, 0), 0, "---", "---", false),
		...
		VENENATIS(TeleportationTypes.PVM, 222255, 57090, "Venenatis", new Location(3283, 3853, 0), 0, "High combat", "40+ Wild", false),
