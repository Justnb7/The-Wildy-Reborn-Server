...
public class SkillInterfaces {
	...
	private void writeInterfaceItem(int id[]) {
			...
			player.outStream.writeWord(8847);
			player.outStream.writeWord(id.length);
			for (int i = 0; i < id.length; i++) {
				player.outStream.writeByte(1);
				if (id[i] > 0) {
					player.outStream.writeWordBigEndianA(id[i] + 1);
				} else {
	...
	public void strengthComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.STRENGTH][0], 0);
	...
	public void defenceComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.DEFENCE][0], 0);// Skill
																	// mastery
	...
	public void magicComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("", "Must have completed Desert Treasure", 6949, 0);
			menuLine("", "", 0, 1);
	...
	public void runecraftingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.RUNECRAFTING][0], 0);
	...
	public void hitpointsComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.HITPOINTS][0], 0);
	...
	public void herbloreComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.HERBLORE][0], 0);
	...
	public void thievingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill mastery",
					skillcapes[Skills.THIEVING][0], 0);
	...
	public void craftingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.CRAFTING][0], 1);
	...
	public void fletchingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.FLETCHING][0], 0);
	...
	public void smithingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.SMITHING][0], 0);
	...
	public void firemakingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.FIREMAKING][0], 0);
	...
	public void woodcuttingComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("99", "Skill Mastery",
					skillcapes[Skills.WOODCUTTING][0], 0);
