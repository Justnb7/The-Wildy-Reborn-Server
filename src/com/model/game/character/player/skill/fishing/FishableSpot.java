 ...
 *
 */
public enum FishableSpot {
	
	
	//TODO add the fishing spawns
	SHRIMPS_AND_ANCHOVIES(1521, 317, 321, 1, 303, 621, false, true, 180, 1, 4),
	TROUT_AND_SALMON(1521, 335, 331, 20, 307, 622, true, true, 460, 2, 4),
	MACKREL(1520, 353, 335, 16, 305, 620, false, false, 360, 1, 4),
	LOBSTER(1519, 377, -1, 40, 301, 619, false, false, 1180, 1, 6),
	KARAMBWAN(635, 3142, -1, 65, 303, 620, false, false, 105, 1, 9),
	MANTA(1526, 389, -1, 81, 303, 620, false, false, 1235, 2, 8),
	TUNA_SWORDFISH(1519, 359, 371, 50, 311, 618,false, true, 760, 2, 5),
	SHARK(1520, 383, 383, 76, 311, 618, false, false, 1620, 2, 7);
	...
	FishableSpot(int spotId, int fishId, int secondFishId, int levelRequired, int toolRequired, int animationId,
			boolean baitRequired, boolean secondFishAvailable, double experience, int option, int timer) {
		this.spot = spotId;
		this.fishId = fishId;
	...
	private static final Set<FishableSpot> FISH = Collections.unmodifiableSet(EnumSet.allOf(FishableSpot.class));
	 ...
	 */
	public static FishableSpot forId(int id, int option) {
