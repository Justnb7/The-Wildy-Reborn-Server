 ...
 */
public enum Pickaxe {
	BRONZE(0, 1265, 1, 625, -1, 0),
	IRON(1, 1267, 1, 626, -1, 2),
	STEEL(2, 1269, 6, 627, -1, 3),
	MITHRIL(3, 1273, 21, 629, -1, 5),
	ADAMANT(4, 1271, 31, 628, -1, 7),
	RUNE(5, 1275, 41, 624, -1, 10),
	DRAGON(6, 11920, 60, 7139, 7138, 12),
	DRAGON_OR(7, 12797, 60, 6746, -1, 12);
	...
	/**
	 * The animation displayed when the special attack is being operated
	 */
	 ...
	 */
	private Pickaxe(int priority, int itemId, int level, int animation, int specAnimation, int extractionReduction) {
		this.priority = priority;
		this.itemId = itemId;
		this.level = level;
		this.animation = animation;
		this.specAnimation = specAnimation;
	...
	/**
	 * The animation displayed when the player uses special attack
	 * @return	the animation displayed
	 */
	public int getSpecAnim() {
		return specAnimation;
	}
