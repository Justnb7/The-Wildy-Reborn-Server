...
public class CacheManager {
	...
	private static CacheManager defsCacheManager;
	
	public CacheManager(String dir, int[] js) {
		try {
			try {
	...
	public static CacheManager getDefinitionsCacheManager() {
		if (defsCacheManager == null) {
			defsCacheManager = new CacheManager("./data/cache/", new int[]{2, 5});
		}
		return defsCacheManager;
	}
