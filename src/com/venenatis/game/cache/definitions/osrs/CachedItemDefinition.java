package com.venenatis.game.cache.definitions.osrs;

import java.util.HashMap;

import com.venenatis.game.cache.OpenRsUnpacker;
import com.venenatis.game.cache.io.osrs.InputStream;
import com.venenatis.game.model.Skills;

public final class CachedItemDefinition {
	
	public static CachedItemDefinition[] definitions;
	...
	public static CachedItemDefinition forId(int itemId) {
		...
		if (def == null) {
			definitions[itemId] = def = new CachedItemDefinition(itemId, OpenRsUnpacker.readData(2, 10, itemId));
		}
		return def;
	}
	...
	private CachedItemDefinition(int id, byte[] data) {
		this.id = id;
