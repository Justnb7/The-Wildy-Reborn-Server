...
public class Seedling {
	...
	public boolean waterSeedling(int itemUsed, int usedWith, int itemUsedSlot, int usedWithSlot) {
		...
		if (seedlingData == null || (!ItemDefinition.get(itemUsed).getName().toLowerCase().contains("watering") && !ItemDefinition.get(itemUsed).getName().toLowerCase().contains("watering")))
			return false;
		...
		player.getActionSender().sendMessage("You water the " + ItemDefinition.get(seedlingData.getSeedId()) + ".");
