...
public abstract class Trap {
	...
	public final RandomGenerator random = new RandomGenerator();
	...
	public Trap(Player player, TrapType type) {
		...
		this.object = new GameObject(type.objectId, player.getLocation());
	}
	...
	public int successFormula(NPC npc) {
		...
		chance = chance + (int) (player.getSkills().getLevel(Skills.HUNTER) / 1.5) + 10;

		if(player.getSkills().getLevel(Skills.HUNTER) < 65) {
			chance = (int) (chance * 1.05) + 3;
		} else if(player.getSkills().getLevel(Skills.HUNTER) < 60) {
			chance = (int) (chance * 1.1);
		} else if(player.getSkills().getLevel(Skills.HUNTER) < 55) {
			chance = (int) (chance * 1.2);
		} else if(player.getSkills().getLevel(Skills.HUNTER) < 50) {
			chance = (int) (chance * 1.3) + 1;
		} else if(player.getSkills().getLevel(Skills.HUNTER) < 40) {
			chance = (int) (chance * 1.4) + 3;
		} else if(player.getSkills().getLevel(Skills.HUNTER) < 25) {
	...
	public void setObject(int id) {
		...
		this.object = new GameObject(id, this.getObject().getLocation());
	}
