...
public class ExtendInterface {
	...
	public enum ExtendButtons {
		...
		NEED_MORE_DARKNESS(new int[] { 91010 }, 6637, "Need more darkness",
				"Whenever you get a Dark Beast task, it" + "\\nwill be a biger task."
						+ " <col=ff0000>(100 points)</col>"),

		ANKOU_VERY_MUCH(new int[] { 91011 }, 6784, "Ankou very much",
		...
		AUGMENT_MY_ABBIES(new int[] { 91027 }, 4149, "Augment my abbies",
