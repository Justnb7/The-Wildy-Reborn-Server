package com.venenatis.game.content.sounds_and_music;
...
import com.venenatis.game.net.packet.in.button.ActionButtonEvent;
			...
			public void onActionButtonClick(Player player, ActionButton button) {
				...
				for (MusicTab element : music) {
					if (button.getId() == element.buttonId) { //Disabled unlocking for now.
						...
						player.getActionSender().sendSong(element.songId);
						setToManual(player);
					}
				}
			}
