...
public class Ranged_Dagganoth extends AbstractBossCombat {
	...
	public void execute(Entity attacker, Entity victim) {
		...
		default:
		case RANGE:
			attacker.setCombatType(CombatStyle.RANGE);
			...
			attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 298, 8, 50, clientSpeed, 10, 35, victim.getProjectileLockonIndex(), 10, 48));
