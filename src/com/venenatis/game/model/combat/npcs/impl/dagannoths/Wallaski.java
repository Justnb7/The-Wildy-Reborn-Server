...
public class Wallaski extends AbstractBossCombat {
	...
	public void execute(Entity attacker, Entity victim) {
		...
		case MAGIC:
			...
			attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 162, 8, 50, clientSpeed, 30, 35, victim.getProjectileLockonIndex(), 10, 48));
