...
public class Bree extends AbstractBossCombat {
	...
	public void execute(Entity attacker, Entity victim) {
		...
		attacker.playProjectile(Projectile.create(attacker.getCentreLocation(), victim.getCentreLocation(), 1186, 45, 50, gfxSpeed, 43, 35, victim.getProjectileLockonIndex(), 10, 48));
