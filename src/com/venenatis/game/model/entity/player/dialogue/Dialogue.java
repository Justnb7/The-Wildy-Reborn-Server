	...
	protected void send(DialogueType type, Object... parameters) {
		if (type == DialogueType.CHOICE) {
			if (parameters.length == 3) {
				...
				player.getActionSender().sendChatBoxInterface(2459);
				...
				player.getActionSender().sendChatBoxInterface(2469);
				...
				player.getActionSender().sendChatBoxInterface(2480);
				...
				player.getActionSender().sendChatBoxInterface(2492);
			} else {
			...
			if (parameters.length == 3) {
				...
				player.getActionSender().sendString((String) parameters[2], 4885);
				player.getActionSender().sendInterfaceAnimation(4883, ((Expression) parameters[1]).getAnimation());
				player.getActionSender().sendNpcHeadToInterface((Integer) parameters[0], 4883);
				player.getActionSender().sendChatBoxInterface(4882);
			} else if (parameters.length == 4) {
				player.getActionSender().sendString(NPC.getName((Integer) parameters[0]), 4889);
				player.getActionSender().sendString((String) parameters[2], 4890);
				player.getActionSender().sendString((String) parameters[3], 4891);
				player.getActionSender().sendInterfaceAnimation(4888, ((Expression) parameters[1]).getAnimation());
				player.getActionSender().sendNpcHeadToInterface((Integer) parameters[0], 4888);
				player.getActionSender().sendChatBoxInterface(4887);
			} else if (parameters.length == 5) {
				...
				player.getActionSender().sendString((String) parameters[3], 4897);
				player.getActionSender().sendString((String) parameters[4], 4898);
				player.getActionSender().sendInterfaceAnimation(4894, ((Expression) parameters[1]).getAnimation());
				player.getActionSender().sendNpcHeadToInterface((Integer) parameters[0], 4894);
				player.getActionSender().sendChatBoxInterface(4893);
			} else if (parameters.length == 6) {
				...
				player.getActionSender().sendString((String) parameters[4], 4905);
				player.getActionSender().sendString((String) parameters[5], 4906);
				player.getActionSender().sendInterfaceAnimation(4901, ((Expression) parameters[1]).getAnimation());
				player.getActionSender().sendNpcHeadToInterface((Integer) parameters[0], 4901);
				player.getActionSender().sendChatBoxInterface(4900);
			} else {
			...
			if (parameters.length == 2) {
				...
				player.getActionSender().sendInterfaceAnimation(969, ((Expression) parameters[0]).getAnimation());
				...
				player.getActionSender().sendInterfaceAnimation(974, ((Expression) parameters[0]).getAnimation());
				...
				player.getActionSender().sendInterfaceAnimation(980, ((Expression) parameters[0]).getAnimation());
				...
				player.getActionSender().sendInterfaceAnimation(987, ((Expression) parameters[0]).getAnimation());
			...
			if (parameters.length == 1) {
				...
				player.getActionSender().sendChatBoxInterface(356);
				...
				player.getActionSender().sendChatBoxInterface(359);
			} else if (parameters.length == 5) {
