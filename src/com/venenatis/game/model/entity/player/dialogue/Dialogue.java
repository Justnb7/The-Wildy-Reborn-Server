	...
	protected void send(Type type, Object... parameters) {
		if (type == Type.CHOICE) {
			...
			if (parameters.length == 3) {
				...
				player.getActionSender().sendString((String) parameters[2], 4885);
				player.getActionSender().sendInterfaceAnimation(4883, ((Expression) parameters[1]).getEmoteId());
				...
				player.getActionSender().sendString((String) parameters[2], 4890);
				player.getActionSender().sendString((String) parameters[3], 4891);
				player.getActionSender().sendInterfaceAnimation(4888, ((Expression) parameters[1]).getEmoteId());
				...
				player.getActionSender().sendString((String) parameters[3], 4897);
				player.getActionSender().sendString((String) parameters[4], 4898);
				player.getActionSender().sendInterfaceAnimation(4894, ((Expression) parameters[1]).getEmoteId());
				...
				player.getActionSender().sendString((String) parameters[4], 4905);
				player.getActionSender().sendString((String) parameters[5], 4906);
				player.getActionSender().sendInterfaceAnimation(4901, ((Expression) parameters[1]).getEmoteId());
			...
			if (parameters.length == 2) {
				...
				player.getActionSender().sendInterfaceAnimation(980, ((Expression) parameters[0]).getEmoteId());
				...
				player.getActionSender().sendInterfaceAnimation(987, ((Expression) parameters[0]).getEmoteId());
