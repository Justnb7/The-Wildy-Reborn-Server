							...
							if (getPhase() == 29) {
								...
								if (getPhase() == 37) {
									...
									case 1:
										...
										player.getInventory().addOrCreateGroundItem(player, new Item(6529, 8000));
									...
									if (getPhase() == 38) {
										switch (index) {
										case 1:
											if (player.getInventory().contains(13225) || player.getBank().contains(13225)) {
											...
											if (roll == 1 || player.getRights().isOwner(player)) {
												receivedPet = true;
											}
