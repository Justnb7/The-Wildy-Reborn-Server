 ...
 *
 */
public class CallistoCub extends Dialogue {
	...
	protected void next() {
		switch (getPhase()) {
		case 0:
			send(DialogueType.NPC, PET, Expression.DEFAULT, "You're not funny...");
			setPhase(1);
			break;
		case 1:
			...
			break;
		case 2:
			send(DialogueType.NPC, PET, Expression.DEFAULT, "You're really not funny...");
			setPhase(3);
			break;
		case 3:
		...
		case 5:
			...
			break;
		case 6:
			send(DialogueType.NPC, PET, Expression.DEFAULT, "If you don't stop,", "I'm going to leave some... brown... at your feet, human.");
			setPhase(7);
			break;
		case 7:
			stop();
