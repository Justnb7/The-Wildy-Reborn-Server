 ...
 *
 */
public class ChaosElementalJr extends Dialogue {
	...
	protected void next() {
		switch (getPhase()) {
		case 0:
			send(DialogueType.NPC, PET, Expression.DEFAULT, "Yes, they killed my mummy,", "kidnapped my brother,", "smiled about it and went to sleep.");
			setPhase(1);
			break;
		case 1:
