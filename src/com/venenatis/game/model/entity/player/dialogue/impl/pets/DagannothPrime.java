 ...
 *
 */
public class DagannothPrime extends Dialogue {
	...
	protected void next() {
		switch (getPhase()) {
		case 0:
			send(DialogueType.NPC, PET, Expression.DEFAULT, "Definitely.");
			setPhase(1);
			break;
		case 1:
			...
			break;
		case 2:
			send(DialogueType.NPC, PET, Expression.DEFAULT, "Ugh. Human, I'm not a pet.");
			setPhase(3);
			break;
		case 3:
			...
			break;
		case 4:
			send(DialogueType.NPC, PET, Expression.DEFAULT, "I can't seem to stop.");
			setPhase(5);
			break;
		case 5:
