 ...
 *
 */
public class GeneralGraardorJr extends Dialogue {
	...
	protected void next() {
		switch (getPhase()) {
		case 0:
			send(DialogueType.NPC, PET, Expression.DEFAULT, "SFudghoigdfpDSOPGnbSOBNfdbdnopbdn", "opbddfnopdfpofhdARRRGGGGH");
			setPhase(1);
			break;
		case 1:
