...
public class PlayerSave {
	...
	public static final class PlayerSaveDetail {
		...
		public static boolean loadDetails(Player player) throws Exception {
			...
			try {
				...
				if(details.playerPerks != null) {
					player.getPerkHandler().setPerkButton(details.playerPerks);
				}
				if(details.assignedPerks != null) {
					player.getPerkHandler().setAssignedPerkTest(details.assignedPerks);
				}
		...
		private final HashMap<String, Double> assignedPerks;
	//	private final ArrayList<String> assignedPerks;
		...
		public PlayerSaveDetail(Player player) {
			...
			playerPerks = player.getPerkHandler().getPerks();
			assignedPerks = player.getPerkHandler().getAssignedPerkTest();
