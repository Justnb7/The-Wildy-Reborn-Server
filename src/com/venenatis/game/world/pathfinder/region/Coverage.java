...
import com.venenatis.game.world.pathfinder.impl.ProjectilePathFinder;
			...
			if (right(c)) {
				if (above(c)) {
					return c.lowerBound.x + c.size == lowerBound.x
							&& c.lowerBound.y + c.size == lowerBound.y;
				} else if (under(c)) {
					return c.lowerBound.x + c.size == lowerBound.x
							&& c.lowerBound.y - 1 == lowerBound.y;
				} else {
					return c.lowerBound.x + c.size == lowerBound.x;
				}
			} else if (left(c)) {
				if (above(c)) {
					return lowerBound.x + size == c.lowerBound.x
							&& lowerBound.y == c.lowerBound.y + c.size;
				} else if (under(c)) {
					return lowerBound.x + size == c.lowerBound.x
							&& lowerBound.y == c.lowerBound.y - 1;
				} else {
					return lowerBound.x + size == c.lowerBound.x;
				}
			} else {
