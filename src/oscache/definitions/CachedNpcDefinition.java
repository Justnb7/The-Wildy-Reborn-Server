...
public final class CachedNpcDefinition {
	...
	public static final CachedNpcDefinition[] npcDefinitions = new CachedNpcDefinition[CacheManager.getDefinitionsCacheManager().getReferenceTables()[2].getArchiveInfomation()[35].getArchiveEntryInfomation().length];
	...
	private final void loadNpcDefinitions() {
		if (cachedArchive == null) {
			cachedArchive = CacheManager.getDefinitionsCacheManager().getArchive(2, 35);
		}
