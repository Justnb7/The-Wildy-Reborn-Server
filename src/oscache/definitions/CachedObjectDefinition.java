...
public final class CachedObjectDefinition {
	...
	public static final CachedObjectDefinition[] objectDefinitions = new CachedObjectDefinition[CacheManager.getDefinitionsCacheManager().getReferenceTables()[2].getArchiveInfomation()[6].getArchiveEntryInfomation().length];
	...
	private final void loadObjectDefinitions() {
		if (cachedArchive == null) {
			cachedArchive = CacheManager.getDefinitionsCacheManager().getArchive(2, 6);
		}
